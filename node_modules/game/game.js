...
exports.spawnPlayer = function(player) {
    player.health = player.max_health;
    exports.spawns.forEach(function(spawn, index, array) {
...
exports.addFlag = function(team, x, y) {
    var body = new Body(team, x, y, 32, 64, 0);
    body.setGroup('flag');
...
exports.addPlatform = function(id, x, y, width, height) {
	var body = new Body(id, x, y, width, height, 0);
...
exports.addPlayer = function(id) {
	var body = new Body(id, 0, 0, 32, 32, 20);
...
exports.manageMouseInput = function (type, x, y, player) {
    if(type == 'down') {
          player.weapon.fire(this, player.body.center(), {x:x, y:y}, player);
    }
};
